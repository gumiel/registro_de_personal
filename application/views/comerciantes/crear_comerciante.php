                  ...
                  <div class="small-12 large-8">
                    ...
                    <div class="row">
                      ...
                      <div class="small-8 columns">
                        <input name="ncaseta" style="font-weight: bold" value="<?php echo set_value('ncaseta', ''); ?>" type="text" id="ncaseta" placeholder="Ingrese el numero de caseta">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                    ...
                    <div class="row">
                      ...
                      <div class="small-8 columns">
                        <input name="codigo" style="font-weight: bold" value="<?php echo set_value('codigo', 'En Tramite'); ?>" type="text" id="codigo" placeholder="Ingrese su codigo de afiliado">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="carnet" style="font-weight: bold" value="<?php echo set_value('carnet', ''); ?>" type="text" id="carnet" placeholder="Ingrese su carnet">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="direccion" style="font-weight: bold" value="<?php echo set_value('direccion', ''); ?>" type="text" id="direccion" placeholder="Ingrese la direccion">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <select name="rubro" id="rubro">                          
                          <option value="rubro 1">rubro 1</option>
                          <option value="rubro 2">rubro 2</option>
                          <option value="rubro 3">rubro 3</option>
                          <option value="rubro 4">rubro 4</option>
                          <option value="rubro 5">rubro 5</option>
                        </select>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="small-8 columns">
                        <textarea name="observacion" id="observacion"><?php echo set_value('observacion', ''); ?></textarea>
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
